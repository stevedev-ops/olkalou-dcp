...
import { Trophy, Star, MapPin, Crown, TrendingUp, Users } from "lucide-react";
...
function MobilizerCard({ mobilizer, currentMemberId }) {
...
export default function Leaderboard({ memberId }) {
          ...
          <div className="space-y-3">
            {loading ? (
              ...
              data.top_mobilizers.map(m => (
                <MobilizerCard key={m.id} mobilizer={m} currentMemberId={memberId} />
              ))
            )}
          </div>
        )}
